...
//TODO-RC: if river is longer than document, make non-overflow, not in SummaryRiver
//TODO-RC: use dark color pallet (theme?)
//TODO-RC: check if roboto font is active?
export const QACard = ({ config }: CardProps) => {
	...
	return (
		<Card variant="elevation" elevation={5} ref={ref}>
